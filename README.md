...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jm5dq9a.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jm5dq9a.containers.anotherwebservice.com/
...
```
git clone git@github.com:geyee/container-jm5dq9a.git
cd container-jm5dq9a
```
...
```
docker attach container-jm5dq9a
```
